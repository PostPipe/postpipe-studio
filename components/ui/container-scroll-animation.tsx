...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border border-white/10 p-0 bg-transparent rounded-[30px] shadow-2xl overflow-hidden will-change-transform"
    >
